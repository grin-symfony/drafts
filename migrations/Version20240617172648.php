 ...
 */
final class Version20240617172648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_passport ADD CONSTRAINT FK_7E12049F4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
